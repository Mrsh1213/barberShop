                                                    ...
                                                    <div>
                                                        ...
                                                        <FormControl variant="outlined" className={classes.formControl}>
                                                            ...
                                                            >
                                                                ...
                                                                <MenuItem value={'0297 00988200918'}>First
                                                                    account</MenuItem>
                                                                <MenuItem value={'0235 00235233332'}>Second
                                                                    account</MenuItem>
                                                                <MenuItem value={'1256 00864222212'}>Third
                                                                    account</MenuItem>
                                                            </Select>
                                                        </FormControl>
                                                    </div>
                                                    ...
                                                    <Grid item xs={6}>
                                                        ...
                                                        <FormControl variant="outlined" className={classes.formControl}>
                                                            ...
                                                            >
                                                                ...
                                                                <MenuItem value={'0297 00988200918'}>Account
                                                                    one</MenuItem>
                                                                <MenuItem value={'0235 00235233332'}>Account
                                                                    two</MenuItem>
                                                                <MenuItem value={'1256 00864222212'}>Other
                                                                    account</MenuItem>
                                                            </Select>
                                                        </FormControl>
                                                    </Grid>
                                                ...
                                                <Grid item container xs={12}>
                                                    <Grid item xs={12}>
                                                        <Typography variant="subtitle1" gutterBottom>
                                                            Congratulations <span role="img"
                                                                                  aria-label="conrats emoji">🎉</span>
                                                        </Typography>
                                                        <Typography variant="body1" gutterBottom>
