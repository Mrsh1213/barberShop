                                        ...
                                        <div className={loading ? classes.loadingState : ''}>
                                            ...
                                            <div style={{marginTop: 14, marginBottom: 14}}>
                                                <div className={classes.inlining}>
                                                    ...
                                                    <Typography className={classes.inlining} variant="subtitle2"
                                                                gutterBottom>
                                                        Type
                                                    </Typography>
                                                    <Typography className={classes.inlining} color='secondary'
                                    ...
                                    <Paper className={classes.paper} style={{position: 'relative'}}>
                                        ...
                                        <div className={loading ? classes.loadingState : ''}>
                                            ...
                                            <div className={classes.mainBadge}>
                                                <VerifiedUserIcon style={{fontSize: 72}} fontSize={'large'}
                                                                  color={'secondary'}/>
                                            ...
                                            <div className={classes.buttonBar}>
                                                <Button to={{pathname: "/dashboard", search: `?type=save`}}
                                                        component={Link} variant="outlined"
                                                        className={classes.actionButtom}>
                                                    Save
                                                </Button>
                                                <Button to={{pathname: "/dashboard", search: `?type=apply`}}
